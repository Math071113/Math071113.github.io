  ...
  const startGame = () => {
   ...
   function resize() {
    ...
    function create() {
     ...
     // Buttons
      buttonUp = game.add.button(800 - 140, 20,'buttonUpBig', actionOnClickUp , this)
      buttonUp.onInputUp.add(()=> isButtonUp = false, this)
      buttonUp.onInputDown.add(()=> isButtonUp = true, this)
    
      buttonLeft = game.add.button(800 - 210, 60,'buttonLeftBig', actionOnClickLeft , this)
      buttonLeft.onInputUp.add(()=> isButtonLeft = false, this)
      buttonLeft.onInputDown.add(()=> isButtonLeft = true, this)
    
      buttonDown = game.add.button(800 -140, 100,'buttonDownBig', actionOnClickDown , this)
      buttonDown.onInputUp.add(()=> isButtonDown = false, this)
      buttonDown.onInputDown.add(()=> isButtonDown = true, this)
    
      buttonRight = game.add.button(800 - 70, 60,'buttonRightBig', actionOnClickRight , this)
